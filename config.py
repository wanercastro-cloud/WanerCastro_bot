...
# Pesos para o score (quanto maior, mais influência)
WEIGHTS = {
    'rsi': 0.3,          # agora o RSI não é só oversold/overbought, mas também momentum
    'macd': 0.4,
    'ema': 0.2,
    'volume': 0.1        # novo peso para volume
}

# Limiares de classificação (ainda usados para neutro/compra/venda)
BUY_THRESHOLD = 0.3      # reduzido para capturar mais cedo
SELL_THRESHOLD = -0.3

# Score mínimo para entrar no ranking (pode ser menor para alertas)
MIN_SCORE_FOR_RANKING = float(os.getenv("MIN_SCORE_FOR_RANKING", "0.4"))

# =====================================================
#  Volume
# =====================================================
VOLUME_MA_PERIOD = 20    # período da média móvel de volume
VOLUME_SPIKE_FACTOR = 1.5  # volume atual > média * este fator = spike
