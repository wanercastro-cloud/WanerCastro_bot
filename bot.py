...
def send_telegram(text):
    ...
    try:
        r = requests.post(url, json={"chat_id": TELEGRAM_CHAT_ID, "text": text, "parse_mode": "HTML"}, timeout=5)
...
def main():
    ...
    # 2. Buscar top 10 moedas (IDs corrigidos)
