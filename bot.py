...
class TelegramNotifier:
    ...
    def send_buy_ranking(self, results, top_n=5, min_score=0.4, title="🚀 TOP OPORTUNIDADES DE COMPRA"):
        ...
        for i, item in enumerate(top_buy, 1):
            # Formata preço (para valores muito baixos, mostra até 8 casas)
            price = item['price']
            if price < 0.01:
...
def scan_loop(notifier):
    ...
    while True:
        if running:
            ...
            # Dorme por até 60 segundos ou até o próximo scan
