...
def check_signals(coin_id, df):
    ...
    """
    # ============================================================
    # DESCOMENTE AS 5 LINHAS ABAIXO PARA FORÇAR UM SINAL DE TESTE
    # NA PRIMEIRA MOEDA DA LISTA (config.COINS_TO_MONITOR[0])
    # ============================================================
    # if coin_id == config.COINS_TO_MONITOR[0]["id"]:
    #     return "LONG", {
    #         "preco": 12345.67,
    #         "rsi": 75.5,
    #         "ema7": 12000,
...
def main():
    ...
    if not TELEGRAM_TOKEN or not TELEGRAM_CHAT_ID:
        logger.error("Credenciais do Telegram não encontradas. Verifique os secrets.")
    if not COINGECKO_API_KEY:
        logger.error("Chave da CoinGecko não encontrada. Verifique o secret.")
