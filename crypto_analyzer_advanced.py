...
# ============================================================
# UTILITÁRIOS - TELEGRAM CORRIGIDO
# ============================================================
def send_telegram_message(message: str):
    """Envia mensagem via Telegram com tratamento de erros e logging."""
...
async def main_async():
    ...
    # Notificação do topo via Telegram (corrigida)
    ...
    elif top_long is not None:
        logger.info("Telegram desabilitado. Nenhuma mensagem enviada.")
